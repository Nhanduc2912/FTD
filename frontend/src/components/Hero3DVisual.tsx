...
export default function Hero3DVisual() {
  ...
  const rotateX = useTransform(mouseY, [-0.5, 0.5], [105, -105]);
  const rotateY = useTransform(mouseX, [-0.5, 0.5], [-105, 105]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          style={{
            transform: "translateZ(-150px) translateX(-80px) translateY(50px)",
          }}
        ...
        <motion.div
          style={{
            transform: "translateZ(-60px) translateX(50px) translateY(-40px)",
            transformStyle: "preserve-3d",
          }}
        ...
        <motion.div
          style={{
            transform: "translateZ(80px) rotateZ(-5deg)",
            transformStyle: "preserve-3d",
          }}
        ...
        >
          ...
          >
            ...
            >
              <Wifi
                size={32}
                className="text-white/80 rotate-90 drop-shadow-lg"
              />
            ...
            <div style={{ transformStyle: "preserve-3d" }}>
              ...
              >
                <div className="text-white/80 text-xs">
                  <div className="mb-1 font-semibold tracking-wider text-[10px]">
                    CARDHOLDER
                  </div>
                ...
                <div className="flex gap-4 items-end">
                  ...
                  <div
                    className="flex -space-x-3 pb-0.5"
        ...
        <motion.div
          style={{
            transform: "translateZ(180px) translateX(100px) translateY(80px)",
          }}
        ...
        <motion.div
          ...
          style={{
            transform: useTransform(
              [x, y],
              ([latestX, latestY]: number[]) =>
                `translateX(${latestX * -50}px) translateY(${latestY * -30}px) scale(${1 - latestY * 0.2})`,
            ),
          }}
        />
      </motion.div>
